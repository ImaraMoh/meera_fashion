          ...
          {wishlistProducts.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-xs text-[#5A4550]">
                Tap the heart icon on any saree or jewellery piece to save it for later.
              </p>
            </div>
          ) : (
            wishlistProducts.map((product) => (
              ...
              >
                <img
                  src={getOptimizedImageUrl(product.images.main, { width: 140, quality: 60, fallbackType: product.category === 'jewellery' ? 'jewellery' : product.category === 'performance' ? 'performance' : 'saree' })}
                  alt={product.name}
                  loading="lazy"
                  decoding="async"
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <button
                      ...
                      className="text-xs flex items-center gap-1 bg-[#9E315A] text-white px-2.5 py-1 rounded-lg font-semibold shadow-2xs"
                    >
                    ...
                    <button
                      ...
                      className="text-xs text-rose-400 hover:text-rose-700 p-1"
                      title="Remove"
                    >
